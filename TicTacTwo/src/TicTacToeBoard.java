...
public class TicTacToeBoard
{
	...
	public boolean spotIsComputer(int spot){
		boolean isComputer = false;
		switch(spot){
			case 1:
				isComputer = this.one == 'O';
				break;
			case 2:
				isComputer = this.two == 'O';
				break;
			case 3:
				isComputer = this.three == 'O';
				break;
			case 4:
				isComputer = this.four == 'O';
				break;
			case 5:
				isComputer = this.five == 'O';
				break;
			case 6:
				isComputer = this.six == 'O';
				break;
			case 7:
				isComputer = this.seven == 'O';
				break;
			case 8:
				isComputer = this.eight == 'O';
				break;
			case 9:
				isComputer = this.nine == 'O';
				break;
		}
		return isComputer;
	}
